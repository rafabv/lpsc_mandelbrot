...
entity pixel_calc is
  ...
  attribute CORE_GENERATION_INFO of pixel_calc : entity is "pixel_calc,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=pixel_calc,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=22,numReposBlks=22,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}";
...
architecture STRUCTURE of pixel_calc is
  ...
  component pixel_calc_add2_0 is
  port (
    A : in STD_LOGIC_VECTOR ( 35 downto 0 );
    B : in STD_LOGIC_VECTOR ( 35 downto 0 );
    S : out STD_LOGIC_VECTOR ( 35 downto 0 )
  );
  end component pixel_calc_add2_0;
  ...
  component pixel_calc_mult_gen_2_0 is
  port (
    A : in STD_LOGIC_VECTOR ( 17 downto 0 );
    B : in STD_LOGIC_VECTOR ( 17 downto 0 );
    P : out STD_LOGIC_VECTOR ( 35 downto 0 )
  );
  end component pixel_calc_mult_gen_2_0;
  ...
  component pixel_calc_mult_gen_4_0 is
  port (
    A : in STD_LOGIC_VECTOR ( 17 downto 0 );
    B : in STD_LOGIC_VECTOR ( 17 downto 0 );
    P : out STD_LOGIC_VECTOR ( 35 downto 0 )
  );
  end component pixel_calc_mult_gen_4_0;
  component pixel_calc_sub_0 is
  port (
    A : in STD_LOGIC_VECTOR ( 35 downto 0 );
    B : in STD_LOGIC_VECTOR ( 35 downto 0 );
    S : out STD_LOGIC_VECTOR ( 35 downto 0 )
  );
  end component pixel_calc_sub_0;
  ...
  component pixel_calc_xlconcat_2_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 13 downto 0 );
    In1 : in STD_LOGIC_VECTOR ( 3 downto 0 );
    dout : out STD_LOGIC_VECTOR ( 17 downto 0 )
  );
  end component pixel_calc_xlconcat_2_0;
  ...
  component pixel_calc_xlslice_4_0 is
  port (
    Din : in STD_LOGIC_VECTOR ( 35 downto 0 );
    Dout : out STD_LOGIC_VECTOR ( 13 downto 0 )
  );
  end component pixel_calc_xlslice_4_0;
  component pixel_calc_xlslice_1_1 is
  port (
    Din : in STD_LOGIC_VECTOR ( 35 downto 0 );
    Dout : out STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  end component pixel_calc_xlslice_1_1;
  component pixel_calc_xlslice_2_1 is
  port (
    Din : in STD_LOGIC_VECTOR ( 35 downto 0 );
    Dout : out STD_LOGIC_VECTOR ( 13 downto 0 )
  );
  end component pixel_calc_xlslice_2_1;
  component pixel_calc_xlconcat_1_1 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 13 downto 0 );
    In1 : in STD_LOGIC_VECTOR ( 3 downto 0 );
    dout : out STD_LOGIC_VECTOR ( 17 downto 0 )
  );
  end component pixel_calc_xlconcat_1_1;
  ...
  signal xlconcat_3_dout : STD_LOGIC_VECTOR ( 17 downto 0 );
  ...
  signal xlslice_6_Dout : STD_LOGIC_VECTOR ( 13 downto 0 );
...
mult_gen_4: component pixel_calc_mult_gen_4_0
     port map (
      A(17 downto 0) => A_0_3(17 downto 0),
      B(17 downto 0) => xlconstant_1_dout(17 downto 0),
      P(35 downto 0) => mult_gen_4_P(35 downto 0)
    );
sub: component pixel_calc_sub_0
     port map (
...
xlconcat_1: component pixel_calc_xlconcat_1_0
     port map (
...
xlconcat_2: component pixel_calc_xlconcat_2_0
     port map (
...
xlconcat_3: component pixel_calc_xlconcat_1_1
     port map (
      In0(13 downto 0) => xlslice_6_Dout(13 downto 0),
      In1(3 downto 0) => xlslice_5_Dout(3 downto 0),
      dout(17 downto 0) => xlconcat_3_dout(17 downto 0)
    );
...
xlslice_1: component pixel_calc_xlslice_1_0
     port map (
      Din(35 downto 0) => add_S(35 downto 0),
      Dout(3 downto 0) => xlslice_1_Dout(3 downto 0)
    );
xlslice_2: component pixel_calc_xlslice_2_0
     port map (
      Din(35 downto 0) => add_S(35 downto 0),
...
xlslice_4: component pixel_calc_xlslice_4_0
     port map (
      Din(35 downto 0) => add1_S(35 downto 0),
      Dout(13 downto 0) => xlslice_4_Dout(13 downto 0)
    );
xlslice_5: component pixel_calc_xlslice_1_1
     port map (
      Din(35 downto 0) => add2_S(35 downto 0),
      Dout(3 downto 0) => xlslice_5_Dout(3 downto 0)
    );
xlslice_6: component pixel_calc_xlslice_2_1
     port map (
      Din(35 downto 0) => add2_S(35 downto 0),
      Dout(13 downto 0) => xlslice_6_Dout(13 downto 0)
    );
end STRUCTURE;
