...
# Tool version: 2021.2
# Description: TCL script for re-creating Vivado project 'lpsc_mandelbrot_firmware'
#
...
if {$PRJ_TYPE == "DESIGN_PRJ_TYPE"} {
  ...
  add_files -fileset constrs_1 -norecurse $src_dir/constrs/lpsc_mandelbrot_firmware.xdc
	set_property is_enabled true [get_files $src_dir/constrs/lpsc_mandelbrot_firmware.xdc]
	add_files -fileset constrs_1 -norecurse $src_dir/constrs/lpsc_mandelbrot_debug.xdc
	set_property is_enabled true [get_files $src_dir/constrs/lpsc_mandelbrot_debug.xdc]
	
  # add IPs source files
  set vhdl_ips_file_list [findFiles ${ip_dir}/lpsc_hdmi/src/hdl *.vhd]
...
set vhdl_ips_file_list [findFiles ${ip_dir}/lpsc_image_generator/src/hdl *.vhd]
	add_files -norecurse $vhdl_ips_file_list
	foreach j $vhdl_ips_file_list {
		set_property file_type {VHDL 2008} [get_files $j]
		print_status "VHDL 2008 mode configured for the file $j" "OK"
	...
	read_ip ${ip_dir}/lpsc_hdmi/src/ip_core/clk_vga_hdmi_640x480/clk_vga_hdmi_640x480.xci
	read_ip ${ip_dir}/lpsc_hdmi/src/ip_core/clk_vga_hdmi_800x600/clk_vga_hdmi_800x600.xci
	read_ip ${ip_dir}/lpsc_hdmi/src/ip_core/clk_vga_hdmi_1024x600/clk_vga_hdmi_1024x600.xci
	read_ip ${ip_dir}/lpsc_hdmi/src/ip_core/clk_vga_hdmi_1024x768/clk_vga_hdmi_1024x768.xci
	read_ip ${ip_dir}/lpsc_bram_video_memory/src/ip_core/bram_video_memory_wauto_dauto_rdclk1_wrclk1/bram_video_memory_wauto_dauto_rdclk1_wrclk1.xci
	read_ip ${ip_dir}/lpsc_clk_mandelbrot/src/ip_core/clk_mandelbrot/clk_mandelbrot.xci
...
# Add packages sources
	set vhdl_pkg_file_list [findFiles ${PRJ_DIR}/../../../../../packages/hw/lpsc_hdmi_interface_pkg/src/hdl *.vhd]
	add_files -norecurse $vhdl_pkg_file_list
	foreach j $vhdl_pkg_file_list {
		set_property is_enabled true [get_files $j]
		set_property library lpsc_lib [get_files $j]
		set_property file_type {VHDL 2008} [get_files $j]
		print_status "VHDL 2008 mode configured for the file $j" "OK"
	}
