...
#
# Generated by Vivado on Tue May 03 18:56:26 +0200 2022
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xlslice_v1_0_2 -L xil_defaultlib -L xlconcat_v2_1_4 -L xlconstant_v1_1_7 -L xbip_utils_v3_0_10 -L xbip_pipe_v3_0_6 -L xbip_bram18k_v3_0_6 -L mult_gen_v12_0_17 -L c_reg_fd_v12_0_6 -L xbip_dsp48_wrapper_v3_0_4 -L xbip_dsp48_addsub_v3_0_6 -L xbip_addsub_v3_0_6 -L c_addsub_v12_0_14 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot pixel_calc xil_defaultlib.pixel_calc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim pixel_calc -key {Behavioral:sim_1:Functional:pixel_calc} -tclbatch cmd.tcl -protoinst "protoinst_files/pixel_calc.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb pixel_calc.wdb xsim.dir)
