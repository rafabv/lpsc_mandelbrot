...
# Tool version: 2021.2
# Description: TCL script for re-creating Vivado project 'lpsc_edge_detector'
#
...
set PRJ_DIR ".."
set prj_name "lpsc_edge_detector"
...
if {$PRJ_TYPE == "DESIGN_PRJ_TYPE"} {
  ...
  # add IPs source files
  set vhdl_ips_file_list [findFiles ${ip_dir}/lpsc_edge_detector/src/hdl *.vhd]
